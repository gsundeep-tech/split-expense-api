...
def create_app():
    ...
    from split_expenses_api.api.modules.users import controller as UserController
    api.add_namespace(UserController.namespace, path="/user")

    from split_expenses_api.api.modules.products import controller as ProdcutsController

...
class ParserFactory:
    ...
    def __init__(self, file_path,
                 invoice_company='lazada_redmart', file_type='pdf'):
    ...
    def extract(self):
        ...
        if self.invoice_company == CompanyInvoices.LAZADA_REDMART \
                and self.file_type == ReceiptFormat.PDF:
...
if __name__ == "__main__":
    ...
    pdf_dir_path = os.path.dirname(__file__) + \
        '/../../tests/resources/lazada_redmart/'
